...
<Section>
	<div class="flex-1">
		<Headline>
			Whatever you need, we can solve <span class="text-white">IT</span>.
		</Headline>
		<Paragraph
			>Book a consultation through
			<br />
			<a class="text-lg lg:text-3xl underline" href="mailto:GreatCompany@gmail.com"
				>GreatCompany@gmail.com</a
			></Paragraph
		>
	</div>
	<BackgroundImage />
